...
public class MainForm extends javax.swing.JFrame implements ImageZoomListener {
    ...
    private void initComponents() {
        ...
        try {
            ...
            e1.printStackTrace();
        } catch (uk.co.mevanspn.gui.BadIconResourceException e2) {
            e2.printStackTrace();
        }
        try {
            ...
            if (choice == JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    if (f != null) {
                        ...
                        b = new Bitmap(source);
                        ippOutput.setImage(b.getCompressPreview(getLumBits(),
                                getChrBits(), getBx(), getBy()));
	...
	private void lumBitsChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_lumBitsChanged
            ...
            if (ippSource.getImage() != null && lum_bits != last_lum_bits) {
                ippOutput.setImage(b.getCompressPreview(lum_bits, chr_bits,
                        bx_size, by_size));
                changeStatus();
